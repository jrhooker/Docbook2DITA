...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:oasis="-//OASIS//DTD XML Exchange Table Model 19990315//EN" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <xsl:template match="table | informaltable" mode="xhtml2cals">
    ...
    <xsl:template match="table | informaltable" mode="convert-to-cals">
        ...
        <oasis:table>
            ...
            <xsl:element name="title"><xsl:value-of select="caption"/></xsl:element>
    ...
    <xsl:template match="caption" mode="convert-to-cals"></xsl:template>
        ...
        <oasis:entry>
            ...
            <xsl:variable name="forced-rowsep" as="xs:boolean">
                <xsl:choose>
                    ...
                    <xsl:when test="ancestor::informaltable[1]/@rules = 'groups' and not(../following-sibling::tr)">true</xsl:when>
                    <xsl:when test="ancestor::informaltable[1]/@rules = 'rows'">true</xsl:when>
                    <xsl:when test="ancestor::informaltable[1]/@rules = 'all'">true</xsl:when>
            ...
            <xsl:variable name="forced-colsep" as="xs:boolean">
                <xsl:choose>
                    ...
                    <xsl:when test="ancestor::table[1]/@rules = 'all'">true</xsl:when>
                    <xsl:when test="ancestor::informaltable[1]/@rules = 'cols'">true</xsl:when>
                    <xsl:when test="ancestor::informaltable[1]/@rules = 'all'">true</xsl:when>
                    <xsl:otherwise>false</xsl:otherwise>
                </xsl:choose>
            </xsl:variable>
